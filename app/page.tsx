  ...
  return (
    <>
      ...
      <section className="trust-bar" aria-label="Why clients trust us">
        {[
          { text: 'Serving Hialeah Families for Over a Decade', icon: trustIcons[0] },
          { text: '100+ Successful Closings Across Miami-Dade County', icon: trustIcons[1] },
          { text: 'Fluent in English and Spanish for Every Client', icon: trustIcons[2] },
          { text: 'Deep Roots in the Hialeah Community', icon: trustIcons[3] },
        ].map((item, i) => (
          <div
          ...
          {[
            {
              ...
              desc: 'From Hialeah Gardens bungalows to Palm Springs North estates, A&B Realty Investments matches buyers and sellers with precision. We know every neighborhood, every price point, and every opportunity in the market.',
            },
            {
              title: 'Investment Properties',
              desc: 'Hialeah\'s rental market is thriving. We identify high-yield duplexes, multi-family units, and commercial properties that put your money to work across Miami-Dade.',
            },
            {
              title: 'First-Time Buyer Programs',
              desc: 'Navigating FHA loans, down payment assistance, and closing costs in South Florida can be overwhelming. Our team walks first-time buyers through every step until the keys are in hand.',
            },
            {
              title: 'Property Valuations',
              desc: 'Get an accurate, data-driven market analysis rooted in real Hialeah comps and neighborhood trends. Know exactly what your property is worth before you list.',
            },
            {
              title: 'Bilingual Transactions',
              desc: 'Fluent in English and Spanish, our agents ensure nothing gets lost in translation. Every contract, negotiation, and closing is handled with clarity and confidence.',
            },
            {
              title: 'Relocation Services',
              desc: 'Moving to Hialeah or anywhere in Miami-Dade? We handle neighborhood matching, school research, and commute logistics so your transition is seamless from day one.',
            },
          ].map((service, i) => (
            <div
      ...
      <section className="section about" aria-label="About us">
        <div className="about-grid">
          ...
          <div className="about-content" data-animate data-delay="2">
            ...
            <p className="about-text">{'A&B Realty Investments was built on a simple belief: every family in Hialeah deserves an agent who treats their home search like their own. We bring deep local expertise, sharp negotiation skills, and genuine care to every transaction across Miami-Dade County. Whether you are buying your first home on East 4th Avenue or building a rental portfolio near Westland Mall, our team is here to make it happen.'}</p>
